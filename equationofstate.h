...
public:
    ...
    virtual Real shearInternalEnergy            (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real shearPressure                  (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real inverseGruneisen               (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual void rootFind                       (BoxAccessCellArray& U, int i, int j, int k, int m, Real kineticEnergy) = 0;
    virtual Real getSoundSpeedContribution      (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real getTemp                        (BoxAccessCellArray& U, int i, int j, int k, int m, int mixidx) = 0;
    virtual Real xi                             (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real componentShearModulus          (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real dGdrho                         (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real dG2drho2                       (BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual Real transverseWaveSpeedContribution(BoxAccessCellArray& U, int i, int j, int k, int m) = 0;
    virtual void setRhoFromDeformationTensor    (BoxAccessCellArray& U, int i, int j, int k, int m, double* F) = 0;
...
/*class MixtureEOS : public EquationOfState
{
...
class RomenskiiSolidEOS : public EquationOfState
{
